pipeline {
    ...
    environment {
        ...
        TRIVY_HOME = '/usr/bin'
        REPO_URL = 'https://github.com/EiMiMiAung/Deploy-Netflix-Clone-on-Kubernetes.git'
        REPO_BRANCH = 'main'
        DOCKER_IMAGE_NAME = 'eimimiaung/netflix'
                    ...
                    script {
                        dir('Kubernetes') {
                            withKubeConfig(
                                ...
                                serverUrl: 'https://D753AA7AC506D7B14EF0A791C5CA7C33.gr7.ap-southeast-1.eks.amazonaws.com', // Replace with actual EKS endpoint
    ...
    post {
        always {
            emailext attachLog: true,
                ...
                to: 'eimimiaung@gmail.com', // Update with your email
